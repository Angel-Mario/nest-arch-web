...
import { ProjectMapSection } from "@/app/_components/project-map-section";
...
export default function Home() {
  return (
    <div className="min-h-screen overflow-hidden bg-background text-foreground selection:bg-red-500/30 selection:text-red-100">
      <main className="mx-auto max-w-7xl space-y-28 px-4 pb-24 pt-10 sm:px-6 lg:px-8 lg:pt-16">
        <HeroSection />
        <WorkflowGallery />
        <FeaturesGrid />
        <ProjectMapSection />
