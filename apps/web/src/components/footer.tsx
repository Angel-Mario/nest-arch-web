...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#06070b] py-12 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          {/* Brand Col */}
          <div className="md:col-span-5 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-rose-500 via-purple-600 to-indigo-600 font-mono font-bold text-white shadow-[0_0_15px_rgba(236,72,153,0.3)]">
                NA
              </div>
          ...
          <div className="md:col-span-3">
            ...
            <div className="rounded-lg border border-white/10 bg-[#0b0c12] p-3 font-mono text-xs text-zinc-400 space-y-1">
              ...
              <p className="text-purple-400">&gt; ship with confidence</p>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 font-mono text-xs text-zinc-500">
